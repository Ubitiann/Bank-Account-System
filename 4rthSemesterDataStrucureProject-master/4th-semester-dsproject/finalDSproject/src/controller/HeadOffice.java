...
public class HeadOffice {
    ...
    public String path_current="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\currentaccount.txt";
    public String path_saving="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\savingaccount.txt";
    public String path_monsaving="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\monthlysavingaccount.txt";
    public String path_fixdep="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\fixeddepositaccount.txt";
    public String path_password="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\passward.txt";
    public String path_requests="F:\\projects\\4th-semester-dsproject\\finalDSproject\\src\\txt_files\\requests.txt";
...
//                    System.out.println("Your Account Number is: " + account_no + " and Branch Code is: " + Information.get(2) + " and you got: " + profit + " after 10 years");
    ...
    public void checkAccount(String name, String path) throws FileNotFoundException, IOException {
        ...
        for (int i = 0; i < Information.size(); i++) {
            ...
            if ((name.equals(split[0])) && path.equals("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\monthlysavingaccount.txt")) {
            ...
            } else if ((name.equals(split[0])) && (path.equals("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\savingaccount.txt")) || (path.equals("C:\\Users\\Hp\\Documents\\NetBeansProjects\\BankAccount\\BankAccount\\src\\bankaccount\\currentaccount.txt"))) {
                System.out.println("Your Account Number is: " + split[1] + " and Branch Code is: " + split[2]);
            } else if ((name.equals(split[0])) && path.equals("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\fixeddepositaccount.txt")) {
