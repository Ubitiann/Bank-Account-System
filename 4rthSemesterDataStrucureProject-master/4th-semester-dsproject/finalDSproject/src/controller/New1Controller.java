...
//    }
    ...
    public New1Controller() throws IOException {
      ...
      this.t = new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\names.txt");
      this.ph_no = new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\phone_number.txt");
      this.adres = new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\address_pr.txt");
      this.dist = new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\district.txt");
      this.cnic = new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\cnic.txt");
...
public void filing(File f,TextField tf) throws IOException{
    ...
    void confirmdetails(ActionEvent event) throws IOException {
        ...
        File f1=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\names.txt");
        File f2=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\cnic.txt");
        File f3=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\phone_number.txt");
        File f4=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\district.txt");
        File f5=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\address_pr.txt");   
        filing(f5,address);
        filing(f4,district);
        filing(f1,name);
        filing(f2,CNIC);
