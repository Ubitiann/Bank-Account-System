...
this.t= new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\title.txt");
this.br= new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\branch_code.txt");
this.ac= new Trie("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\account_number.txt");
}
...
if(title.getText().isEmpty() || acnumber.getText().isEmpty() || brcode.getText().isEmpty() ){
        ...
        File f1=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\title.txt");
        File f2=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\branch_code.txt");
        File f3=new File("C:\\Users\\M.Ahsan\\Documents\\NetBeansProjects\\finalDSproject\\src\\txt_files\\remove_account\\account_number.txt");
        filing(f1,title);
        filing(f2,brcode);
        filing(f3,acnumber);
        }
